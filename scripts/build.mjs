...
const STRUCTURE = [
  ...
  },
  {
    ...
    files: [
      ...
      { src: "handbook/07-knowledge-management.md", title: "ナレッジ管理・更新運用" },
      { src: "handbook/08-finance-billing.md", title: "経理・請求フロー" },
      { src: "handbook/09-client-offboarding.md", title: "クライアントオフボーディング" },
      { src: "handbook/10-design-research.md", title: "デザインリサーチ：参考と「らしさ」の見つけ方" },
    ],
  },
  {
    chapter: "02",
    ...
    files: [
      ...
      { src: "templates/codex-prompts/corporate.md", title: "コーポレートサイト業態" },
      { src: "templates/codex-prompts/extension-sections.md", title: "FV後の6セクション拡張" },
      { src: "templates/codex-prompts/beauty-salon.md", title: "美容室・サロン業態" },
      { src: "templates/codex-prompts/clinic.md", title: "整体・治療院業態" },
      { src: "templates/codex-prompts/real-estate.md", title: "不動産仲介業態" },
      { src: "templates/codex-prompts/school.md", title: "スクール・教育業態" },
      ...
      { src: "templates/client-emails/estimate.md", title: "メール: 見積書送付" },
      { src: "templates/client-emails/contract.md", title: "メール: 契約書送付" },
      { src: "templates/client-emails/invoice.md", title: "メール: 請求書送付" },
      { src: "templates/client-emails/kickoff.md", title: "メール: キックオフMTG案内" },
      { src: "templates/client-emails/delivery-completion.md", title: "メール: 公開完了報告" },
      { src: "templates/client-emails/handover-completion.md", title: "メール: 引き渡し完了" },
      { src: "templates/client-emails/cancellation-acknowledgement.md", title: "メール: 解約受領確認" },
      { src: "templates/client-emails/follow-up-3m.md", title: "メール: 公開3ヶ月後フォロー" },
  ...
  },
  {
    ...
    files: [
      ...
      { src: "decision-trees/contract-type.md", title: "契約形態の選択" },
    ],
  },
  {
    chapter: "04",
  ...
  },
  {
    ...
    files: [
      ...
      { src: "runbooks/incident-response.md", title: "クレーム・障害対応" },
    ],
  },
];
